...
code obtained from: https://gist.github.com/spitis/27ab7d2a30bbaf5ef431b4a02194ac60
"""
	...
	def _batch_norm(self, x, name_scope, step, epsilon=1e-5, no_offset=False, set_forget_gate_bias=False):
		...
		with tf.variable_scope(name_scope):
			...
			if no_offset:
				...
				offset = tf.get_variable('offset', [size], initializer=tf.zeros_initializer())#used to be tf.zeros_initializer w/o ()
